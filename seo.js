(function () {
  ...
  footer.innerHTML = '<nav aria-label="Breadcrumb"><a href="' + root + '">Home</a> <span aria-hidden="true">/</span> <a href="' + root + 'blog/">Rice Purity Test Guides</a> <span aria-hidden="true">/</span> <span>' + current.title + '</span></nav>' +
    ...
    '<h2>Related Rice Purity Test Guides</h2><p><a href="' + root + '">Take the Rice Purity Test</a> · <a href="' + root + 'blog/rice-purity-test-score-meaning/">Rice Purity score meaning chart</a> · <a href="' + root + 'blog/history-of-the-test.html">Rice Purity Test history</a> · <a href="' + root + 'blog/faq.html">Rice Purity Test FAQ</a></p>';
